...
import com.backendmysql.controller.CoffeeshopController;
...
public class CoffeeshopControllerTest {
	...
	private List<Coffeeshop> prepareCoffeeshopRecords(){
		...
		Coffeeshop coffeeshop1 = new Coffeeshop(1L, "vEs5Q",new Double(95.07),new Date(),true);
		Coffeeshop coffeeshop2 = new Coffeeshop(2L, "IjLco",new Double(88.82),new Date(),false);
	...
	private List<CoffeeshopDto> prepareCoffeeshopDtoRecords(){
		...
		CoffeeshopDto coffeeshop1 = new CoffeeshopDto("vEs5Q",new Double(95.07),new Date(),true);
		CoffeeshopDto coffeeshop2 = new CoffeeshopDto("IjLco",new Double(88.82),new Date(),false);
