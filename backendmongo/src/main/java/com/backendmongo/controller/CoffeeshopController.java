...
public class CoffeeshopController {
	...
	public Coffeeshop fetchById(@PathVariable String id) {
	...
	public ResponseEntity<Object> update(@Valid @RequestBody CoffeeshopDto coffeeshopDto, @PathVariable String id) {
